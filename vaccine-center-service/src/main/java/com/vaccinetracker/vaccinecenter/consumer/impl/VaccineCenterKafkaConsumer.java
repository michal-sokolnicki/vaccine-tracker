package com.vaccinetracker.vaccinecenter.consumer.impl;
...
import com.vaccinetracker.vaccinecenter.consumer.KafkaConsumer;
...
@Slf4j
@Service
public class VaccineCenterKafkaConsumer implements KafkaConsumer<Long, BookingAvroModel> {
