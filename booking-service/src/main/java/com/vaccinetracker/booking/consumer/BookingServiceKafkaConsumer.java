package com.vaccinetracker.booking.consumer;
...
public class BookingServiceKafkaConsumer implements KafkaConsumer<String, VaccinationStatusAvroModel> {
    ...
    public void receive(@Payload List<VaccinationStatusAvroModel> messages,
        ...
        bookingService.processMessages(messages);
    }
}
