...
@Primary
@Service
public class BookingElasticQueryClient extends ElasticRepositoryQueryClientBase<BookingIndexModel>
    ...
    public BookingElasticQueryClient(BookingElasticsearchQueryRepository bookingElasticsearchQueryRepository) {
